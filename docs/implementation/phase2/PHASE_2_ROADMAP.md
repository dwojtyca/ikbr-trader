...
| PR15.5C.1 | IBKR ES source parity and immutable dataset acquisition | **COMPLETE / READY: IBKR bundle acquired and imported; provenance `ibkr-es-20250622-20260831-e39a59790324`, fingerprint `6dc425610feb44665226228bbd2c561b64504b47588b4dd38d26cc9dab93e026`, 99.9858% selected-contract completeness; dataset remains ready for PR15.5D.1** (see [PR15_5C_1_REPORT.md](PR15_5C_1_REPORT.md)) |
...
| PR15.5D.1 | Active-contract projection remediation and newly registered ES compatibility experiment | **STAGE A IMPLEMENTED / STAGE B HOLD: projection and all HTF identities frozen and structurally verified; no v2 real experiment claim or performance run started** (see [plan](PR15_5D_1_ACTIVE_CONTRACT_REMEDIATION_PLAN.md) and [Stage A report](PR15_5D_1_STAGE_A_REPORT.md)) |
